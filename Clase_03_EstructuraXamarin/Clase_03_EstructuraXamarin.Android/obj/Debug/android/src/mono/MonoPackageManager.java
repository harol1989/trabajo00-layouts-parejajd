...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "Clase_03_EstructuraXamarin.Android.dll" comes first in this list. */
		"Clase_03_EstructuraXamarin.Android.dll",
		"Clase_03_EstructuraXamarin.dll",
		"FormsViewGroup.dll",
